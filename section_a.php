		...
		<?php
				if($_SERVER["REQUEST_METHOD"]=="POST"){
					...
					if ($_POST['sdate'])
					{
						...
						$dquery="ALTER TABLE sec_a ADD $today VARCHAR(30)";
				   ...
				   elseif($_POST['present']){
				   	...
				   	$dquery="UPDATE sec_a SET $sdate='P' WHERE regd_no=$rno";
				   ...
				   elseif($_POST['absent']){
				   	$rno=$_POST['absent'];
				   	$sdate=$_SESSION["sdate"];
				   	$dquery="UPDATE sec_a SET $sdate='A' WHERE regd_no=$rno";
					$dresult=mysqli_query($con,$dquery) or die(mysqli_error($con));
				...
				$query = "SELECT * FROM sec_a"; //You don't need a ; like you do in SQL

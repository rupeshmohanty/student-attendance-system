...
<html>
	...
	<body class="subpage">
		...
		<!-- Header -->
			...
			<form method="post" action="section_a.php">
				<button type="submit" class="btn btn-primary" style="margin-left: 10px;">Sec A</button>
			</form>	
			<form method="post" action="section_b.php">
				<button type="submit" class="btn btn-primary" style="margin-left: 10px;">Sec B</button>
			</form>
